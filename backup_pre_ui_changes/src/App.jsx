...
export default function App() {
  ...
  // Derived filtered view — keeps components pure
  ...
  return (
    <CartProvider>
      <div className="min-h-screen bg-[url('/assets/service.png')] bg-cover bg-center text-white">
        <div className='backdrop-blur-sm bg-gradient-to-b from-brand-900/60 via-transparent to-brand-900/60'>
          <Header />
