...
export default function App() {
  ...
  return (
    <CartProvider>
      <div className='min-h-screen text-white bg-[#523C14]'>
        <div className='relative'>
          <div className='absolute inset-0 bg-[url("/assets/serrvices.png")] bg-cover bg-top opacity-70' />
          <div className='absolute inset-0 bg-[linear-gradient(180deg,#523C14_0%,#614F38_12%,#A47828_20%,#523C14_100%)] opacity-85' />
          ...
          <div className='relative backdrop-blur-[2px]'>
            ...
            <main className='container mx-auto px-6 py-10'>
              <section className='mb-10'>
                <h2 className='text-5xl font-light text-center mb-2'>
                  Dịch Vụ
                </h2>
        ...
        {!loading && !error && (
          <div className='bg-[linear-gradient(180deg,#523C14_0%,#614F38_12%,#A47828_20%,#523C14_100%)]'>
